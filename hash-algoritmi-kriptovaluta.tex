...
Kriptovaluta je vrsta digitalnog novca, elektronski način razmjene novca i zapisivanja transakcija na računalu. To je sredstvo razmjene koje koristi kriptografiju kako bi stvorilo i osiguralo prijenos novca.\cite{cc-wiki} Za razliku od banaka, kriptovalute su decentralizirani sustav što znači da nema središnje organizacije koja kontrolira vrijednost, provjerava transakcije, može utjecati da korisnik prima ili šalje novac, ili na bilo koji drugi način utječe na razmjenu novca. Kriptovaluta je peer-to-peer sustav razmjene što znači da za svoje funkcioniranje koristi rad svojih korisnika, oni su zaslužni za stvaranje novih novčanih jedinica i prijenos postojećih.\\
...
Nakon sto je Satoshi 2009? objavio svoj rad u kojem opisuje kriptovalutu Bitcoin naglo je poraslo zanimanje za to područje.
Stari koncept je predstavio na novi, moderan i upotrebljiv nacin te omogucio stvaranje i razvoj ostalih kriptovaluta.
Vrhunac popularnosti je dosegao x godine a otad je daleko najvrijednija valuta poznata siroj javnosti a ne samo specificnim skupinama.\\
Od ostalih kriptovaluta vrijedi izdvojiti Ethereum jer nije samo obicna kriptovvaluta vec nudi ostale stvari.
\cite{bitcoin}
...
\end{itemize}
%
Ethash koriste kriptovalute

\pagebreak
\section{Zaključak}
Osim navedenih algoritama, u svijetu se za razlicite svrhe koristi jos nebrojeno mnogo drugih algoritama i hash funkcija.
Pojava kriptovaluta, prvenestveno Bitcoina, svakako je povoljno utjecala na osmisljavanje novih algoritama i motivaciju za njihovo istrazivanje i testiranje. \\
Algoritmi su svakako kljucni doo kriptovaluta i blockchaina na temelju kojeg su one implementirane. Utjecu na njihovu sigurnost, ispravnost....\\
Najveci neprijatelj su im ASICovi koji svojim vlasnicima omogucavaju vrlo brzo i efikasno rudarenje naspram ostalih obicnih korisnika koji koriste cpu i gpu. Cilj svih navedenih algoritama je nauspjesno bio pokusati onemoguciti izradu ASICova za taj specificni algoritam. Pojedini su uspjeli samo odgoditi i oduziti njihov razvoj.\\
U interesu je svima da se tako nesto i dogodi jer bi zasigurno pozitivno utjecalo kako na kriptovalutu koja ce prva poceti koristiti taj algoritam tako i sve grane racunarstva, matematike? Koje se bave kriptoanalizom.
